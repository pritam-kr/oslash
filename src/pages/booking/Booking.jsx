...
const Booking = () => {
    const {shitReducer : {selectedShits}} = useSelector(state => state)
        ...
        <div className='billing-card w-billing-card border-2 '>
            <header className='movies-details flex'>
                ...
                <div className='ticket-img flex justify-center items-center'>
                    <img className='w-full' src={"https://res.cloudinary.com/dhqxln7zi/image/upload/v1657283987/1_gi9fnt.png"} alt="ticket" />
                </div>
            </header>
